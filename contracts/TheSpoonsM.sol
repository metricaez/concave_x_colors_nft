 ...
 */
contract TheSpoonsM is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function generateSVGImage(uint256 tokenId) internal view returns (string memory) {
      ...
      return ITheSpoonsSVG(THE_SPOONS_SVG).generateSVGImage(tokenId,hexCode,"","",0,0,0);
    }
    ...
    function generateSpoonTraits(uint256 tokenId, uint32 r, uint32 g, uint32 b) internal view returns (SpoonTraits memory) {
